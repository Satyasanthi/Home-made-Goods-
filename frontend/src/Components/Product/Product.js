    ...
    return ( 
      ...
      {error && <p style={{ color: 'red' }}>{error}</p>}
        <div className="Ppart1">
          ...
          <div className="Ppart2" style={{ width:"480px"}}>
              <div>
                <FontAwesomeIcon onClick={() => handleAddTowish({product: props.pro, customerEmail:uemail})} disabled={loading} icon={faHeart} size="1x" color="red" className="w" />Wishlist
              </div>
